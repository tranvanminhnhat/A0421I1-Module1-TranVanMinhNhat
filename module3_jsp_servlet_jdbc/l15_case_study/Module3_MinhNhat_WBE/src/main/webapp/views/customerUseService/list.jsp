...
<html>
<head>
    <title>Customer use Service</title>
...
<div class="content">
    ...
    <div class="main-content">
        <table id="customerTable" class="table table-striped table-bordered table-hover table-responsive-md">
            <thead>
            <tr>
                <th colspan="8"><h3 style="font-family: sans-serif; text-align: center;">Customer Use Service List</h3></th>
            </tr>
            ...
            <c:forEach items="${customerUseServiceList}" var="customer">
                <tr>
                    ...
                    <td>${customer.attachService.attach_service_name}</td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
