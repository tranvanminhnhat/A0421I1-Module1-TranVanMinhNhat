...
<%--    </div>--%>
    <div class="main-content">
        <form>
            <div>
                <h3 style="font-family: sans-serif; text-align: center;">Delete Service</h3>
            </div>
            <div><input type="hidden" name="service_id" value="${service.service_id}"></div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label>Name</label>
                    <input type="text" class="form-control" name="service_name" value="${service.service_name}" readonly>
                </div>
                <div class="form-group col-md-3">
                    <label>Area</label>
                    <input type="text" class="form-control" name="service_area" value="${service.service_area}" readonly>
                </div>
                <div class="form-group col-md-3">
                    <label>Cost</label>
                    <input type="text" class="form-control" name="service_cost" value="${service.service_cost}" readonly>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-3">
                    <label>Max People</label>
                    <input type="text" class="form-control" name="service_max_people" value="${service.service_max_people}" readonly>
                </div>
                <div class="form-group col-md-3">
                    <label>Standard Room</label>
                    <input type="text" class="form-control" name="standard_room" value="${service.standard_room}" readonly>
                </div>
                <div class="form-group col-md-6">
                    <label>Other Convenience</label>
                    <input type="text" class="form-control" name="description_other_convenience" value="${service.description_other_convenience}" readonly>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-3">
                    <label>Pool Area</label>
                    <input type="text" class="form-control" name="pool_area" value="${service.pool_area}" readonly>
                </div>
                <div class="form-group col-md-3">
                    <label>Number of Floors</label>
                    <input type="text" class="form-control" name="number_of_floors" value="${service.number_of_floors}" readonly>
                </div>
                <div class="form-group col-md-3">
                    <label>Rent Type</label>
                    <input type="text" class="form-control" name="rent_type_id" value="${service.rent_type_id}" readonly>
                </div>
                <div class="form-group col-md-3">
                    <label>Service Type</label>
                    <input type="text" class="form-control" name="service_type_id" value="${service.service_type_id}" readonly>
                </div>
            </div>
<%--            <button type="submit" style="background-color: #046056; color: #fff;" class="btn">Delete</button>--%>
            <button type="button" style="background-color: #046056; color: #fff;" class="btn" onclick="putDataToModal('${service.service_id}')"
        ...
        <form action="/service?action=delete" method="post">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input id="service_id" hidden name="service_id">
                    <input id="nameService" hidden>
