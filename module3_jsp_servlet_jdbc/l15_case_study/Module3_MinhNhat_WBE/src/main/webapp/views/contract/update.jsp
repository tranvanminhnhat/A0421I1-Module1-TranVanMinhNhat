...
<%--    </div>--%>
    <div class="main-content">
        <form action="/contract?action=update" method="post">
            <div>
                <h3 style="font-family: sans-serif; text-align: center;">Update Contract</h3>
            </div>
            <input name="contract_id" type="hidden" value="${contract.contract_id}">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label>Start Date</label>
                    <input type="date" class="form-control" name="contract_start_date" value="${contract.contract_start_date}">
                </div>
                <div class="form-group col-md-6">
                    <label>End Date</label>
                    <input type="date" class="form-control" name="contract_end_date" value="${contract.contract_end_date}">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label>Deposit</label>
                    <input type="text" class="form-control" name="contract_deposit" value="${contract.contract_deposit}">
                </div>
                <div class="form-group col-md-6">
                    <label>Total Money</label>
                    <input type="text" class="form-control" name="contract_total_money" value="${contract.contract_total_money}">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" name="employee_id">
                        <c:forEach items="${employeeList}" var="employee">
                            <option value="${employee.employee_id}"${employee.employee_id == contract.employee_id?"selected":""}>${employee.employee_name} - (ID: ${employee.employee_id})</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" name="customer_id">
                        <c:forEach items="${customerList}" var="customer">
                            <option value="${customer.customer_id}"${customer.customer_id == contract.customer_id?"selected":""}>${customer.customer_name} - (ID: ${customer.customer_id})</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" name="service_id">
                        <c:forEach items="${serviceList}" var="service">
                            <option value="${service.service_id}"${service.service_id == contract.service_id?"selected":""}>${service.service_name} - (ID: ${service.service_id})</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
