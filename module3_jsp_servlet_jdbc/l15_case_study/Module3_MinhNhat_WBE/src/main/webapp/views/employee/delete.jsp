...
<%--    </div>--%>
    <div class="main-content">
        <form action="/employee?action=delete" method="post">
            <div>
                <h3 style="font-family: sans-serif; text-align: center;">Delete Employee</h3>
            </div>
            <input name="employee_id" type="hidden" value="${employee.employee_id}" readonly>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label>Name</label>
                    <input type="text" class="form-control" name="employee_name" value="${employee.employee_name}" readonly>
                </div>
                <div class="form-group col-md-6">
                    <label>Division</label>
                    <input type="text" class="form-control" name="division_id" value="${employee.division_id}" readonly>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label>Birthday</label>
                    <input type="date" class="form-control" name="employee_birthday" value="${employee.employee_birthday}" readonly>
                </div>
                <div class="form-group col-md-4">
                    <label>Identity Card</label>
                    <input type="text" class="form-control" name="employee_id_card" value="${employee.employee_id_card}" readonly>
                </div>
                <div class="form-group col-md-4">
                    <label>Position</label>
                    <input type="text" class="form-control" name="position_id" value="${employee.position_id}" readonly>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label>Salary</label>
                    <input type="text" class="form-control" name="employee_salary" value="${employee.employee_salary}" readonly>
                </div>
                <div class="form-group col-md-4">
                    <label>Phone</label>
                    <input type="text" class="form-control" name="employee_phone" value="${employee.employee_phone}" readonly>
                </div>
                <div class="form-group col-md-4">
                    <label>Email</label>
                    <input type="email" class="form-control" name="employee_email" value="${employee.employee_email}" readonly>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label>Education</label>
                    <input type="text" class="form-control" name="education_degree_id" value="${employee.education_degree_id}" readonly>
                </div>
                <div class="form-group col-md-8">
                    <label>Address</label>
                    <input type="text" class="form-control" name="employee_address" value="${employee.employee_address}" readonly>
                </div>
            </div>
<%--            <button type="submit" style="background-color: #046056; color: #fff;" class="btn">Delete</button>--%>
            <button type="button" style="background-color: #046056; color: #fff;" class="btn" onclick="putDataToModal('${employee.employee_id}')"
        ...
        <form action="/employee?action=delete" method="post">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input id="employee_id" hidden name="employee_id">
                    <input id="nameEmployee" hidden>
                    <span>Are you sure to delete this employee</span>
                </div>
