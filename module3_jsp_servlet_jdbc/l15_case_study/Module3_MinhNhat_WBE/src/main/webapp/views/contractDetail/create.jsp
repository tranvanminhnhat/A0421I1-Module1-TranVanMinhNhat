...
<%--    </div>--%>
    <div class="main-content">
        <form action="/contractDetail?action=create" method="post">
            <div>
                <h3 style="font-family: sans-serif; text-align: center;">Create Contract Detail</h3>
            </div>
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" name="attach_service_id">
                        <c:forEach items="${attachServiceList}" var="attachService">
                            <option value="${attachService.attach_service_id}">${attachService.attach_service_name} (ID: ${attachService.attach_service_id})</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-group col-md-3">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="quantity" placeholder="${quantityMessage}">
                </div>
                <div class="form-group col-md-3">
