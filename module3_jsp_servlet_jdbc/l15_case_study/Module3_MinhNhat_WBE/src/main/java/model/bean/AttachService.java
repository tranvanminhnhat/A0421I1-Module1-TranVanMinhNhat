...
public class AttachService {
    ...
    public AttachService(int attach_service_id, String attach_service_name, double attach_service_cost, int attach_service_unit, String attach_service_status) {
    ...
    public AttachService(String attach_service_name) {
        this.attach_service_name = attach_service_name;
    }
