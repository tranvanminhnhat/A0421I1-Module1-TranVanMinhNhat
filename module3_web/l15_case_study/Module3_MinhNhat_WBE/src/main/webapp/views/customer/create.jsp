...
<%--    </div>--%>
    <div class="main-content">
        <form action="/customer?action=create" method="post">
            <div>
                <h3 style="font-family: sans-serif; text-align: center;">Create Customer</h3>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label>Name</label>
                    <input type="text" class="form-control" name="customer_name" placeholder="${nameMessage}">
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <p style="color: red;">${birthdayMessage}</p>
                </div>
                <div class="form-group col-md-6">
                    <label>Identity Card</label>
                    <input type="text" class="form-control" name="customer_id_card" placeholder="${idCardMessage}">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label>Phone</label>
                    <input type="text" class="form-control" name="customer_phone" placeholder="${phoneMessage}">
                </div>
                <div class="form-group col-md-6">
                    <label>Email</label>
                    <input type="text" class="form-control" name="customer_email" placeholder="${emailMessage}">
                </div>
            </div>
