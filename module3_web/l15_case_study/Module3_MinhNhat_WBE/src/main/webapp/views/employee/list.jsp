...
<%--    </div>--%>
    <div class="main-content">
        <table id="employeeTable" class="table table-striped table-bordered table-hover table-responsive-md">
            <thead>
            <tr>
                <th colspan="8"><h3 style="font-family: sans-serif; text-align: center;">Employee List</h3></th>
            </tr>
            <tr style="background-color: #046056; color: #fff">
                ...
                <th class="text-center">
                    <a href="/employee?action=create" style="color: #fff;"><i class="far fa-plus-square"></i></a>
                </th>
            </tr>
            </thead>
            <tbody>
            <c:forEach items="${employeeList}" var="employee">
                <tr>
                    ...
                    <td class="text-center">
                        <a href="/employee?action=update&id=${employee.employee_id}" style="color: #fff;"><i class="fas fa-edit text-primary"></i></a>
                        <a href="/employee?action=delete&id=${employee.employee_id}"><i class="far fa-trash-alt text-danger"></i></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
        ...
        <form class="form-inline" action="/employee?action=search" method="post">
            ...
            <div class="form-group mx-sm-3 mb-2">
                <label class="sr-only">Employee address</label>
                <input type="text" name="employeeAddress" class="form-control" placeholder="Employee address">
            </div>
