...
<%--    </div>--%>
    <div class="main-content">
        <table id="serviceTable" class="table table-striped table-bordered table-hover table-responsive-md">
            <thead>
            <tr>
                <th colspan="8"><h3 style="font-family: sans-serif; text-align: center;">Service List</h3></th>
            </tr>
            <tr style="background-color: #046056; color: #fff">
                ...
                <th class="text-center">
                    <a href="/service?action=create" style="color: #fff;"><i class="far fa-plus-square"></i></a>
                </th>
            </tr>
            </thead>
            <tbody>
            <c:forEach items="${serviceList}" var="service">
                <tr>
                    ...
                    <td class="text-center">
                        <a href="/service?action=update&id=${service.service_id}" style="color: #fff;"><i class="fas fa-edit text-primary"></i></a>
                        <a href="/service?action=delete&id=${service.service_id}"><i class="far fa-trash-alt text-danger"></i></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
