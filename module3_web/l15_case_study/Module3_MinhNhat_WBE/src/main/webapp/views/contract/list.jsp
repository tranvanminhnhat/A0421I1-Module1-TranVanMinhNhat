    ...
    <div class="main-content">
        <table id="contractTable" class="table table-striped table-bordered table-hover table-responsive-md">
            ...
            <tr style="background-color: #046056; color: #fff">
                ...
                <th class="text-center">
                    <a href="/contract?action=create" style="color: #fff;"><i class="far fa-plus-square"></i></a>
                </th>
            </tr>
            </thead>
            <tbody>
            <c:forEach items="${contractList}" var="contract">
                <tr>
                    ...
                    <td class="text-center">
                        <a href="/contract?action=update&id=${contract.contract_id}" style="color: #fff;"><i class="fas fa-edit text-primary"></i></a>
                        <a href="/contract?action=delete&id=${contract.contract_id}"><i class="far fa-trash-alt text-danger"></i></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
        ...
        <form class="form-inline" action="/contract?action=search" method="post">
            <div class="form-group mx-sm-3 mb-2">
                <label class="sr-only">Employee</label>
