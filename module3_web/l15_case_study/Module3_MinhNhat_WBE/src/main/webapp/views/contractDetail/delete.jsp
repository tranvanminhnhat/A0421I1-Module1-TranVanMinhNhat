...
<html>
<head>
    <title>Delete Contract Detail</title>
...
<%--    </div>--%>
    <div class="main-content">
        <form action="/contractDetail?action=delete" method="post">
            <div>
                <h3 style="font-family: sans-serif; text-align: center;">Delete Contract Detail</h3>
            </div>
            <input name="contract_detail_id" type="hidden" value="${contractDetail.contract_detail_id}">
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="contract_id" value="${contractDetail.contract_id}" readonly>
                </div>
                <div class="form-group col-md-3">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="attach_service_id" value="${contractDetail.attach_service_id}" readonly>
                </div>
                <div class="form-group col-md-3">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="quantity" value="${contractDetail.quantity}" readonly>
                </div>
                <div class="form-group col-md-3">
...
<%--                    <button type="submit" style="background-color: #046056; color: #fff;" class="btn">Delete</button>--%>
                    <button type="button" style="background-color: #046056; color: #fff;" class="btn" onclick="putDataToModal('${contractDetail.contract_detail_id}')"
        ...
        <form action="/contractDetail?action=delete" method="post">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input id="contract_detail_id" hidden name="contract_detail_id">
                    <input id="nameContractDetail" hidden>
                    <span>Are you sure to delete this contract detail</span>
                </div>
...
<script>
    function putDataToModal(id, name) {
        document.getElementById("nameContractDetail").innerText = name;
