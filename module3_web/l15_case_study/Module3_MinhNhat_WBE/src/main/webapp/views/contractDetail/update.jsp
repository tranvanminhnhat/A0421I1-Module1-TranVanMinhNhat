...
<html>
<head>
    <title>Update Contract Detail</title>
...
<%--    </div>--%>
    <div class="main-content">
        <form action="/contractDetail?action=update" method="post">
            <div>
                <h3 style="font-family: sans-serif; text-align: center;">Update Contract Detail</h3>
            </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" name="contract_id">
                        <c:forEach items="${contractList}" var="contract">
                            <option value="${contract.contract_id}"${contract.contract_id == contractDetail.contract_id?"selected":""}>ID: ${contract.contract_id}--(Date: ${contract.contract_start_date})</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" name="attach_service_id">
                        <c:forEach items="${attachServiceList}" var="attachService">
                            <option value="${attachService.attach_service_id}"${attachService.attach_service_id == contractDetail.attach_service_id?"selected":""}>${attachService.attach_service_name} (ID: ${attachService.attach_service_id})</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-group col-md-3">
