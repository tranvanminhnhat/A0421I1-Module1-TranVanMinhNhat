...
<%--    </div>--%>
    <div class="main-content">
        <table id="contractDetailTable" class="table table-striped table-bordered table-hover table-responsive-md">
            <thead>
            <tr>
                <th colspan="8"><h3 style="font-family: sans-serif; text-align: center;">Contract Detail List</h3></th>
            </tr>
            <tr style="background-color: #046056; color: #fff">
                ...
                <th class="text-center">
                    <a href="/contractDetail?action=create" style="color: #fff;"><i class="far fa-plus-square"></i></a>
                </th>
            </tr>
            </thead>
            <tbody>
            <c:forEach items="${contractDetailList}" var="contractDetail">
                <tr>
                    ...
                    <td>${contractDetail.attachService.attach_service_name}</td>
                    <td>${contractDetail.quantity}</td>
                    <td class="text-center">
                        <a href="/contractDetail?action=update&id=${contractDetail.contract_detail_id}" style="color: #fff;"><i class="fas fa-edit text-primary"></i></a>
                        <a href="/contractDetail?action=delete&id=${contractDetail.contract_detail_id}"><i class="far fa-trash-alt text-danger"></i></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
        <form class="form-inline" action="/contractDetail?action=search" method="post">
            <div class="form-group mx-sm-3 mb-2">
                <label class="sr-only">Attach Service</label>
                <input type="text" name="attachService" class="form-control" placeholder="Attach service">
            </div>
            <div class="form-group mx-sm-3 mb-2">
